...
def main():
    ...
    while True:
        lookahead = input("\nЧисло букв, проверяемых после знака препинания: ")
        if lookahead.isdigit():
            lookahead = int(lookahead)
            break
        else:
            print("Пожайлуста, введите число.", file=sys.stderr)
    print()
